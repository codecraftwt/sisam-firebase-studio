  ...
  const benefits = [
    {
      ...
      description:
        "Up to 30% cost savings compared to traditional transport methods with better container utilization.",
    },
    {
      icon: <ClockIcon className="w-10 h-10" />,
      title: "Fast Loading",
      description:
        "Quick loading and unloading process reduces port dwell time and transportation delays.",
    },
    {
      icon: <ShieldCheckIcon className="w-10 h-10" />,
      title: "Contamination Free",
      description:
        "Single-use design eliminates cross-contamination risks and ensures product purity.",
    },
    {
      icon: <TruckIcon className="w-10 h-10" />,
      title: "Easy Handling",
      description:
        "Simplified logistics with standard container dimensions fitting all transport modes.",
    },
  ];
        ...
        <div ref={heroRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-textMuted max-w-4xl mx-auto mb-8">
              Revolutionary flexible container technology for cost-effective
              bulk liquid transportation. Transform standard shipping containers
              into efficient liquid transport systems.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-textMuted max-w-3xl mx-auto">
              Discover why FlexiTank technology is revolutionizing bulk liquid
      ...
      <section className="py-20 bg-surfaceGlass backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-textMuted max-w-3xl mx-auto">
              Detailed specifications and capabilities of our FlexiTank
              solutions.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-textMuted max-w-3xl mx-auto">
              Understanding which products are suitable for FlexiTank
              transportation ensures safe and efficient logistics.
            </p>
          </div>
      ...
      <section className="py-20 bg-surfaceGlass backdrop-blur-lg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-textMuted max-w-3xl mx-auto">
              A streamlined process from installation to discharge ensures
            ...
            {[
              {
                step: "01",
                title: "Installation",
                description: "FlexiTank installed in standard container",
              },
              {
                step: "02",
                title: "Loading",
                description: "Liquid pumped directly into FlexiTank",
              },
              {
                step: "03",
                title: "Transport",
                description: "Safe transport via ship, rail, or truck",
              },
              {
                step: "04",
                title: "Discharge",
                description: "Liquid pumped out and tank disposed",
              },
            ].map((process, index) => (
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-textMuted mb-8 max-w-2xl mx-auto">
            Contact our FlexiTank experts to determine if this solution is right
            for your liquid transport needs.
          </p>
