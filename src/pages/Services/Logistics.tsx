...
import { TruckIcon, MapIcon, ClockIcon, ShieldCheckIcon, GlobeAltIcon, ChartBarIcon } from '@heroicons/react/24/outline';
  ...
  const features = [
    {
      ...
      description: "Seamlessly integrated road, rail, sea, and air transportation solutions for optimal efficiency and cost-effectiveness."
    },
    {
      icon: <MapIcon className="w-10 h-10" />,
      title: "Real-Time Tracking",
      description: "Advanced GPS tracking and IoT sensors provide real-time visibility into your shipments' location and condition."
    },
    {
      icon: <ClockIcon className="w-10 h-10" />,
      title: "Time-Definite Delivery",
      description: "Guaranteed delivery windows with proactive communication and contingency planning for schedule adherence."
    },
    {
      icon: <ShieldCheckIcon className="w-10 h-10" />,
      title: "Cargo Protection",
      description: "Comprehensive insurance coverage and secure handling protocols ensure your goods arrive safely and intact."
    },
    {
      icon: <GlobeAltIcon className="w-10 h-10" />,
      title: "Global Network",
      description: "Extensive partner network across 50+ countries enabling seamless international shipping and customs clearance."
    },
    {
      icon: <ChartBarIcon className="w-10 h-10" />,
      title: "Analytics & Reporting",
      description: "Detailed performance metrics and customizable reports help optimize your supply chain and reduce costs."
    }
  ];
  ...
  const services = [
    {
      ...
      description: "Complete freight forwarding services including documentation, customs clearance, and door-to-door delivery.",
      features: ["Air & Sea Freight", "Customs Clearance", "Documentation", "Insurance"]
    },
    {
      title: "Warehousing & Distribution",
      description: "Modern warehouse facilities with advanced inventory management and distribution capabilities.",
      features: ["Climate-Controlled Storage", "Inventory Management", "Pick & Pack", "Distribution"]
    },
    {
      title: "Supply Chain Consulting",
      description: "Expert consultation to optimize your supply chain, reduce costs, and improve operational efficiency.",
      features: ["Process Optimization", "Cost Analysis", "Risk Assessment", "Technology Integration"]
    }
  ];
    ...
    <div className="min-h-screen pt-16">
        ...
        <div ref={heroRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-textMuted max-w-4xl mx-auto mb-8">
              End-to-end logistics services that streamline your supply chain, reduce costs, and ensure timely delivery 
              across our global network of trusted partners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-textMuted max-w-3xl mx-auto">
              Comprehensive logistics solutions powered by advanced technology and decades of industry expertise.
            </p>
          </div>
      ...
      <section className="py-20 bg-surfaceGlass backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-textMuted max-w-3xl mx-auto">
              Tailored logistics solutions designed to meet your specific industry requirements and operational needs.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-textMuted max-w-3xl mx-auto">
              A systematic approach that ensures efficiency, transparency, and successful delivery every time.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {[
              { step: "01", title: "Consultation", description: "Understand requirements and constraints" },
              { step: "02", title: "Planning", description: "Design optimal route and timeline" },
              { step: "03", title: "Pickup", description: "Secure collection from origin point" },
              { step: "04", title: "Transit", description: "Real-time monitoring during transport" },
              { step: "05", title: "Delivery", description: "Safe delivery to final destination" }
            ].map((process, index) => (
      ...
      <section className="py-20 bg-surfaceGlass backdrop-blur-lg">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-text mb-6">
            Ready to Optimize Your <span className="text-accent">Logistics?</span>
          </h2>
          <p className="text-xl text-textMuted mb-8 max-w-2xl mx-auto">
            Contact our logistics experts today for a customized solution that fits your specific requirements and budget.
          </p>
